...
<template>
  <RangeCalendarRoot
    ...
    :class="
      cn(
        'rounded-md border border-border bg-(--background-elevated) p-3',
        props.class,
      )
    "
  >
      ...
      <div class="flex flex-col gap-4 sm:flex-row">
        ...
        >
          <RangeCalendarHeader class="relative flex w-full items-center justify-center">
            <RangeCalendarPrev
              v-if="monthIndex === 0"
              class="absolute left-1 inline-flex h-7 w-7 items-center justify-center rounded-md border border-border bg-background text-foreground hover:bg-(--background-muted)"
            >
            ...
            <RangeCalendarNext
              ...
              class="absolute right-1 inline-flex h-7 w-7 items-center justify-center rounded-md border border-border bg-background text-foreground hover:bg-(--background-muted)"
            >
            ...
            <RangeCalendarGridHead>
              <RangeCalendarGridRow class="flex">
                <RangeCalendarHeadCell
                  ...
                  :key="day"
                  class="h-9 w-9 text-xs font-medium text-muted-foreground"
                >
                  {{ day }}
                </RangeCalendarHeadCell>
              </RangeCalendarGridRow>
