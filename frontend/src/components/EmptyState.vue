...
<template>
  <div
    data-empty-state
    class="mx-auto flex w-full max-w-3xl flex-col items-center justify-center rounded-xl border border-dashed border-border bg-[var(--background-muted)]/40 px-6 py-12 text-center"
  >
